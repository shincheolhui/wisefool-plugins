...
|---|---|---|
| [work-lifecycle](plugins/work-lifecycle/) | Makes Claude Code work like a disciplined teammate — triage, isolated worktree, tracked issue, verified merge, every session. — Claude Code 를 규율 있는 팀 동료처럼 — 질문엔 조사만, 착수엔 격리 워크트리→이슈 추적→검증된 머지를 한 절차로 | `/plugin install work-lifecycle@wisefool-plugins` |
